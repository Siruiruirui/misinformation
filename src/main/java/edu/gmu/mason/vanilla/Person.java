...
public class Person implements Steppable, java.io.Serializable {
	...
	// mis-information
	@Characteristics
	private double onlineSpreadProbability;
	@Characteristics
	private double offlineSpreadProbability;
	@Characteristics
	private boolean possessMisinformation;
...
//		if(journalEnabled)
	...
	public double getJovialityBase() {
 	...
 	// mis-information
	public void setOnlineSpreadProbability(double prop) {
		this.onlineSpreadProbability = prop;
	}

	public void setOfflineSpreadProbability(double prop) { this.offlineSpreadProbability = prop;
	}
	public void setPossessMisinformation(boolean bl) {
		this.possessMisinformation = bl;
	}

	public boolean getPossessMisinformation() {
		return this.possessMisinformation;
	}

	public double getOnlineSpreadProbability() {
		return this.onlineSpreadProbability;
	}

	public double getOfflineSpreadProbability() { return this.offlineSpreadProbability; }
