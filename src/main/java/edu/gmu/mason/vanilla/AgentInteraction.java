...
public class AgentInteraction implements java.io.Serializable {
	...
	public long getInteractionEndStep() {
		System.out.println(interactionEndStep);
	...
	public long getAgent1() { return agent1; }

	public void setAgent1(long agent1) { this.agent1 = agent1; }

	public long getAgent2() { return agent2; }

	public void setAgent2(long agent2) { this.agent2 = agent2; }
